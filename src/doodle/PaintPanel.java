...
class PaintPanel extends StackPane implements Observer, EventHandler<MouseEvent> {
	...
	public PaintPanel(PaintModel model) {
		...
		this.canvas.addEventHandler(MouseEvent.ANY, this); // handles mouse events
		this.setPaintModel(model); // hook the model up
	}
	...
	public void setPaintModel(PaintModel model) {
		...
		this.model = model;
		// this will change according to the button
